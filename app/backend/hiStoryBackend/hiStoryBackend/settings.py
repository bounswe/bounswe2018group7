...
REC_NUMBER_OF_RANDOM_USER_POSTS = os.environ.get('REC_NUMBER_OF_RANDOM_USER_POSTS', 5)
REC_NUMBER_OF_RANDOM_OTHER_POSTS = os.environ.get('REC_NUMBER_OF_RANDOM_OTHER_POSTS', 15)
REC_NUMBER_OF_RESULTS = os.environ.get('REC_NUMBER_OF_RESULTS', 5)
